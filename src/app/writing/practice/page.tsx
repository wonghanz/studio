  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6 pb-24">
      <header className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">Standard Practice</h1>
          <p className="text-sm text-muted-foreground">Draft essays and receive official rubric feedback.</p>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <Card className="border-none shadow-sm border-l-4 border-l-blue-500 bg-blue-50/30">
          ...
          {feedback ? (
            <Card className="border-accent shadow-md bg-accent/5 animate-in slide-in-from-right-4">
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between mb-2">
                  <Badge variant="default" className="bg-accent">Tutor Feedback</Badge>
              ...
              <CardContent className="space-y-4 max-h-[400px] overflow-auto pr-2">
                ...
                <div className="pt-2">
                  <h4 className="text-sm font-bold mb-1">Detailed Analysis</h4>
            ...
            <div className="h-full flex flex-col items-center justify-center p-8 text-center text-muted-foreground space-y-4">
              ...
              <p className="text-sm">Submit your draft to receive an AI evaluation.</p>
            </div>
          )}
        </div>
      </div>
